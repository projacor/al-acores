            ...
            {lista.map((a) => (
              <tr key={a.id} className="hover:bg-gray-50">
                <td className="px-3 py-2">
                  <a href={a.url} target="_blank" className="font-medium text-blue-700 hover:underline">
                    {a.nome}
                  </a>
                </td>
                <td className="px-3 py-2 text-gray-600">{a.ilha ?? '—'}</td>
                <td className="px-3 py-2 text-gray-600">{a.morada ?? '—'}</td>
                <td className="px-3 py-2 text-gray-600">{a.rral_detetado ?? '—'}</td>
                <td className="px-3 py-2">
                  {a.suspeito ? (
